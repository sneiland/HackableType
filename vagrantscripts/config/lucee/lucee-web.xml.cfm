<?xml version="1.0" encoding="UTF-8" standalone="no"?><cfLuceeConfiguration salt="F733DECF-E1E3-4318-A2D1870956E767D9" version="5.2">
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
		<data-source allow="511" always-set-timeout="true" blob="true" class="com.mysql.cj.jdbc.Driver" clob="true" connectionLimit="100" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;serverTimezone=Etc%2FUTC&amp;maxReconnects=3&amp;jdbcCompliantTruncation=true&amp;allowMultiQueries=true" database="hackableType" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" id="mysql" liveTimeout="60" metaCacheTimeout="60000" name="hackableType" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:b0752555b00c3407154fa7e0af2829315c2b095925db6cec690f00b357ecec26" port="3306" storage="false" username="webuser" validate="false"/>
	</data-sources>
	...
	<mail>
		<server idle="10000" life="60000" password="" port="2525" reuse-connection="true" smtp="10.0.2.2" ssl="false" tls="false" username=""/>
	</mail>
